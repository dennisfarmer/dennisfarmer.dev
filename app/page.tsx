...
const experiences = [
  {
    position: "Bioinformatics and Machine Learning",
    start_date: new Date("May 2024"),
    //end_date: "",
    company: "Welch Laboratory",
    //href: "",
  ...
  },
  {
    ...
    start_date: new Date("September 2022"),
    end_date: new Date("August 2023"),
    company: "Dr. Patrick Grim",
    //href: "",
    location: "Ann Arbor, MI",
    description: "this is a description",
  },
  {
    position: "Bioinformatics and Computer Vision",
    start_date: new Date("May 2022"),
    end_date: new Date("December 2022"),
    company: "Maerz Laboratory",
    location: "Ann Arbor, MI",
    description: "this is a description",
  },
];
  ...
  return (
    <div className="overflow-hidden">
      <div className="block h-fit mt-6 sm:w-4/5 w-full px-10">
        <div className="line text-4xl">Hi, I&apos;m Dennis.</div>
        <div className="line sm:text-2xl text-xl mt-1">
          I&apos;m a data scientist and music composer.
        </div>
        ...
        <Dropdown icon="library" title="Skills">
          <div className="md:text-sm text-xs">
            <LineWithHeading
              ...
              description="C++, Python, R, SQL, Bash, React"
            />
            <LineWithHeading
              heading="Tools and Software"
              description="Linux, (Neo)vim, Valgrind, Docker, Azure, CMake"
            />
            {//<LineWithHeading
